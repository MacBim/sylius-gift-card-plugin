...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('macbim_gift_card_plugin.workflow.increase_amount', DecreaseGiftCardAmountModifierWorkflow::class)
        ->arg('$giftCardAmountModifier', service('macbim_sylius_gift_cards.modifier.amount_modifier'));
    ...
    $services
        ...
        ->arg('$entityManager', service('doctrine.orm.entity_manager.class'));
