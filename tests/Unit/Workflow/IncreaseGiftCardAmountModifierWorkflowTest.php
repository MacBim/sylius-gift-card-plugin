...
#[CoversClass(IncreaseGiftCardAmountModifierWorkflow::class)]
class IncreaseGiftCardAmountModifierWorkflowTest extends TestCase
{
    private GiftCardAmountModifierInterface $amountModifier;

    private IncreaseGiftCardAmountModifierWorkflow $workflow;

    protected function setUp(): void
    {
        $this->amountModifier = $this->createMock(GiftCardAmountModifierInterface::class);

        $this->workflow = new IncreaseGiftCardAmountModifierWorkflow(
            $this->amountModifier
        );
    }
